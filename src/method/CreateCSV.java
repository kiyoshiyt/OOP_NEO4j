...
public class CreateCSV {
	...
	public void CreateDBtoCSV(int numEvenToTime, int numLocationToOrganization, int numPersonToEven,
			int numPersonToOrganization, int numPersonToCountry) {
		...
		country.createToCSV("src/database/Country.csv");
		event.createToCSV("src/database/Event.csv");
		location.createToCSV("src/database/Location.csv");
		person.createToCSV("src/database/Person.csv");
		organiation.createToCSV("src/database/Organization.csv");
		time.createToCSV("src/database/Time.csv");
	...
	public static void main(String[] args) {
		CreateCSV csv = new CreateCSV(70, 5, 5, 2, 10, 8);// nguo
		csv.CreateDBtoCSV(30, 30, 50, 60, 60);
